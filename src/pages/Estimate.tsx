export default function EstimateForm() {
    return (
        <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4">
            <h1 className="text-5xl font-extrabold text-black mb-4">Devis</h1>
            {/* Phrase sous le titre */}
            <p className="text-xl text-gray-700 mb-10 text-center max-w-md">
              Obtenez votre devis <span className="font-semibold">gratuit</span> et personnalisé en quelques clics.
            </p>
            <form
